...
т.к. это поможет в дальнейшем самостоятельно установить приложения. 
Хорошая статья на тему - [Zeekr 001: Установка любых приложений](https://telegra.ph/Zeekr-001-Ustanovka-lyubyh-prilozhenij-01-14)
...
1. ключ-карта:
     ...
     * нельзя надолго (более 5 мин) оставлять на беспроводной зарядке
