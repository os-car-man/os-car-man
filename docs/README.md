...
могут скатать в официальный сервис и включить английский язык [^2], но местами там
все равно будут видны иероглифы. Уточняйте этот момент у своего дилера. 
Так же было бы весьма кстати попросить поставщика оставить доступ по ADB открытым,
т.к. это поможет в дальнейшем самостоятельно установить приложения. (_об этом отдельная статья будет_)
...
Крайне рекомендуем ознакомится с данным видео, для понимания процессов зарядки элкетро автомобилей:
...
* медленные (AC - переменный ток)
    ...
    * 11кВт (три фазы, 16А каждая) - авто, выпущенные до февраля 2023. Если есть 2
      доп. контакта как под красными стрелками, значит у вас машина может
      принять 3 фазы.
