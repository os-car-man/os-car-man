...
все равно будут видны иероглифы (**ТРЕБУЕТ ПОДТВЕРЖДЕНИЯ**).
...
только она покидает Китай, она перестает отправлять общаться с Zeekr серверами
...
Что особенного дает MA? то же, что МА +

* позволяет раздавать FA 3-им лицам
