...
* медленные (AC - переменный ток)
    ...
    * 7 кВт[^2] (32А, **только одна фаза**) - предел медленной зарядки для
      китайских Zeekr-ов 
...
могут скатать в официальный сервис и включить английский язык [^3], но местами там
...
1. т.к. машина имеет свой вшитый номер телефона (в блоке телематики впаяна eSIM
   ...
   видео своего лица, шевеля им под китайские инструкции на экране. [^4]
...
[^2]:
    авто, выпущенные до февраля 2023, могут заряжаться тремя фазами по 7кВт
    (32А) каждая -- заветные 22кВт.
