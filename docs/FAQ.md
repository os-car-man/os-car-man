...
Если этого не достаточно, то можно открыть приложение и посмотреть в нем раздел с машиной:

**001 и 009**:

* Пролестайте чуть ниже, там где кружок с девушкой, под ним будут иконки, если есть иконка "куба" - значит у вас MA
...
* Если есть раздел с версией ПО - значит у вас МА
  ...
  ??? info "фото"
        ![2024-01-15-x-MA](img/2024-01-15-x-MMA.jpg){ loading=lazy }
