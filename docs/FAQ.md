...
## На планшете вверху красная надпись <span style="color:red">交付中心模式中</span> (delivery mode), из которого не получается "выйти".

У вас не пройдена предпродажная подготовка. Самостоятельно убрать эту надпись
не получится - только через специалистов за деньги. Задайте вопрос своему
поставщику - продавать авто без предпродажной подготовки крайне не
профиссионально, старайтесь избегать таких поставщиков.
