...
* убедитесь, что ключ в машине и приложен к считывателю
* откройте водительскую дверь, сядьте и закройте дверь
* зажмите аварийку на не менее чем 7 секунд, пока не пройдут самопроверки на
  малом экране
* включите нейтраль (N)

После погрузки:

* включите паркинг (P) передачу
