...
Оставил машину на зарядке от обычной ракетки на 5 дней. В результате батарею зарядил, а вот 12В аккумулятор сел ( видимо при зарядке работает какая-то Электроника от 12В сети).
Решение:

Шаг первый - попасть в машину.

Под правой фарой в бампере лючек. В нем 2 провода (красный и черный). На них нужно подать питание 12В. Я это сделал прикурив от машины с ДВС (естественно не заведенной). После подключения прикладывайте карточку к арке - откроется водительская дверь. При этом машина останется дохлой.
Шаг второй - раскирпичивание

Открываете капот. В нише переднего багажника лючек - открываете. В нем, в нише с правой стороны плюсовая Клема 12В сети. Минус любой открытый метал ( я кинул провод на петлю капота. После подключения внешнего аккумулятора ( не заводя машину с ДВС) к клемам Zeekr и ключом снимаете с охраны (кнопка с открытым замком на пульте).
Машина оживает!
