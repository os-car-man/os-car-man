...
## Проблемы с камерами кругового обзора

В чате есть видео с извлечением определенного предохранителя для перезагрузки
одного из блоков, которого не берут обычные перезагрузки, но пока нет
подтвержденных случаев, что именно это помогло.

Предположительно, должна помочь более простая процедура со сбрасыванием
