...
!!! warning
    ...
    (jack mode) в настройках. [Как включать смотрим тут.](/service/#shinomontazh) Если этого не сделать - машина опустится и загорится ошибка пневмы. Нужно поднять опустить заднюю подвеску кнопками в багажнике, либо проехать несколько метров и ошибка пропадет. 
